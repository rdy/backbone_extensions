      ...
      self[name] = {
        ...
        'undefined': function () {
          if (associationOptions.create) {
            ...
            var object = Klass && new Klass(null, _(initializeOptions).omit('klass'));
        ...
        parseAssociation(this._wrapped, name, options, {
          defaultParse: function(response) {
            if(response && response[name] && this[name]()) {
              this[name]().add(response[name], {parse: true});
            }
        ...
        parseAssociation(this._wrapped, name, options, {
          defaultParse: function(response) {
            if(response && response[name] && this[name]()) {
              ...
              this[name]().set(response[name], {silent: true, parse: true});
              this[name]().change();
            }
            return _(response).omit(name);
          }
