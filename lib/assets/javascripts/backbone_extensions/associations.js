...
(function(_, Backbone) {
  function mixin(namespace) {
    ...
    function buildHasAssociation(associationType, Klass, associationName, options) {
      var collectionName = _.str.classify(associationName), _has = '_' + associationType;

      Klass.prototype[associationName] = function() {
        this[_has] = this[_has] || {};
        this[_has][associationName] = this[_has][associationName] ||
        ...
        return (this._options && this._options[associationName] && this._options[associationName]()) || this[_has][associationName];
      };
    }
