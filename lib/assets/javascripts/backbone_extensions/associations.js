    ...
    function buildAssociation(associationType, associationName, options) {
      function through(association) {
        if (options.through) {
          ...
          return (association &&
              association.add((_(options.through).isString() && this[throughName]() || options.through.call(this))
                  .invoke(_(associationName).singularize()), mergeAssociationOptions({parse: true}, options, this.options))) ||
